...
function draw(gl, shaderProgram, object) {
  ...
  matrix = Mat4.multiply(matrix, Mat4.perspective(Math.PI / 4, (gl.canvas.width / gl.canvas.height), 0, 1200));
  matrix = Mat4.multiply(matrix, Mat4.translate(0, -250, 860));
  matrix = Mat4.multiply(matrix, Mat4.rotateY(-1.0));
